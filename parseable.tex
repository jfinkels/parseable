...
We will consider also permutation problems corresponding to \lang{PARSEABLE}, \lang{CLOSED}, and \lang{NVQ}.
...
\begin{langdef}{\pp}
  \begin{instance}
    finite sets $V, A, F, P,$ and $L$ as described above, and $\phi$ a word over the alphabet $V\cup A\cup F\cup P\cup L$ of length $n$
  \end{instance}
  \begin{question}
    Does there exist a permutation on $n$ elements, $\sigma$, such that $\sigma(\phi)\in\lang{PARSEABLE}$?
  \end{question}
\end{langdef}
...
\begin{langdef}{\pc}
  ...
  \end{instance}
  \begin{question}
    Does there exist a permutation on $n$ elements, $\sigma$, such that $\sigma(\phi)\in\lang{CLOSED}$?
  \end{question}
\end{langdef}
...
\begin{langdef}{\pn}
  ...
  \end{instance}
  \begin{question}
    Does there exist a permutation, $\sigma$, of the symbols of $\phi$ such that $\sigma(\phi)\in\lang{NVQ}$?
  \end{question}
\end{langdef}
...
\begin{todo}
  Explain the significance of the \lang{\pp}, \lang{\pc}, and \lang{\pn} problems with respect to natural language parsing and computational linguistics.
\end{todo}

\begin{openproblem}
  Is $\lang{\pc}\in\INDEXED$?
  Is it in $\MCSL$?
  Generally, permutations of parseable languages are easier than the originals, so it should be possible to put $\lang{\pc}\in\INDEXED$.
  To show this, one might start by showing that a one-way nondeterministic nested stack automaton accepts $\lang{\pc}$.
